...
const Footer = ({ 
  ...
  const copyright = copyrightText || `© ${currentYear} PLP Task Manager. All rights reserved.`;
          ...
          <div className="flex flex-wrap justify-center md:justify-start space-x-6 md:order-2">
            {footerLinks.map((link, index) => (
              <Link
                key={link.name}
                to={link.href}
                className="text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-sm transition-all duration-200 hover:underline hover:scale-105 transform"
          ...
          <div className="flex justify-center space-x-6 md:order-3 mt-4 md:mt-0">
            {footerSocialLinks.map((social, index) => (
              <a
                ...
                className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300 transition-all duration-200 transform hover:scale-110 hover:-translate-y-1"
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
          <div className="text-center">
            <p className="text-xs text-gray-400 dark:text-gray-500">
              Built with React, Tailwind CSS, and ❤️ for PLP Academy
            </p>
          </div>
        </div>
      </div>
